...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BatchRecord.file'
        db.delete_column('doc_engine_batchrecord', 'file')


    def backwards(self, orm):
        
        # Adding field 'BatchRecord.file'
        db.add_column('doc_engine_batchrecord', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
